...
namespace Checkpoint.RWIntegration
{
    class AES
    {
        ...
        public readonly static int QTD_BYTES_BLOCO = 16;
        public readonly static int QTD_CARACTERES_CHAVE = 64;
        ...
        private const string cryptoKey = "B42F110B1814A8F55A547869966CDEEB59557FB6CCB6E770D9646E97C0C4B9F8";
        ...
        public static byte[] Encrypt(byte[] bText)
        {
            try
            {
        ...
        public static byte[] Decrypt(byte[] bText)
        {
            try
            {
                // Se a string não está vazia, executa a criptografia           
